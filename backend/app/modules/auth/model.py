...
from sqlalchemy import CheckConstraint, DateTime, String, Integer
...
class User(Base):
    ...
    textbook_progress: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
